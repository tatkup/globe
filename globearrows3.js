...
function FsGlobe() {
  ...
  s.enablePan = false;
  s.minDistance = 1.2;
  s.maxDistance = 8; // Adjusted max distance
  s.autoRotate = true;
  ...
  s.enableZoom = true;
  s.minZoom = 5;
  s.maxZoom = 40; // Adjusted max zoom
...
function FsGlobe() {
  ...
  function updateControls() {
    ...
    s.rotateSpeed = 0.5 + 0.4 * Math.pow(1 - zoomFactor, 2);
    s.panSpeed = 0.3 + 0.2 * Math.pow(1 - zoomFactor, 2);
    R(); // Render after update
  }
