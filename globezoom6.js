...
function FsGlobe() {
  ...
  (s.enableDamping = !0), (s.enablePan = !1), (s.minDistance = 1.2), (s.maxDistance = 4), (s.autoRotate = !0), (s.domElement.focus = null), (s.autoRotateSpeed = 0.05), s.target.set(0, 0, 0), r.position.set(2.5, 0, 0), (s.enableZoom = !0), s.minZoom = 5, s.maxZoom = 55, s.dampingFactor = 0.85, s.update();
